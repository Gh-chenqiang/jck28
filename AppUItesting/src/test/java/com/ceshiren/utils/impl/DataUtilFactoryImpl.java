...
import com.ceshiren.utils.DataUtilFactory;
 ...
 */
public class DataUtilFactoryImpl implements DataUtilFactory {
    static final String TEST_DATA_FILE_PATH = "src/test/resources/data/";
    private static ObjectMapper objectMapper;

    @Override
    public  <T> List<T> YamlUtilFactory(EntityFileMapping entityFileMap) throws IOException {
        // 实例化Yaml工厂
